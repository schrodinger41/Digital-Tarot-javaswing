...
class DecisionTree {
        ...
        private void buildTrees() {
                ...
                DecisionNode foolStep2Yes = new DecisionNode("Do you feel spontaneous today?", foolStep3Yes,
                                foolStep3No);
                DecisionNode foolStep2No = new DecisionNode("Do you prefer careful planning?", foolStep3No,
                                foolStep3Yes);
                ...
                DecisionNode magicianStep2No = new DecisionNode("Do you trust your abilities?", magicianStep3Yes,
                                magicianStep3No);
                DecisionNode magicianRoot = new DecisionNode("Do you feel confident?", magicianStep2Yes,
                                magicianStep2No);
                ...
                DecisionNode emperorStep2Yes = new DecisionNode("Are you ready to lead?", emperorStep3Yes,
                                emperorStep3No);
                DecisionNode emperorStep2No = new DecisionNode("Do you desire stability?", emperorStep3No,
                                emperorStep3Yes);
                DecisionNode emperorRoot = new DecisionNode("Do you feel authoritative?", emperorStep2Yes,
                                emperorStep2No);
                ...
                DecisionNode hierophantStep2Yes = new DecisionNode("Do you value conventional wisdom?",
                                hierophantStep3Yes,
                                hierophantStep3No);
                ...
                DecisionNode loversStep2Yes = new DecisionNode("Do you feel connected to someone?", loversStep3Yes,
                                loversStep3No);
                DecisionNode loversStep2No = new DecisionNode("Are you seeking companionship?", loversStep3No,
                                loversStep3Yes);
                ...
                DecisionNode justiceStep2Yes = new DecisionNode("Do you seek fairness?", justiceStep3Yes,
                                justiceStep3No);
                ...
                DecisionNode hangedStep2No = new DecisionNode("Are you willing to surrender?", hangedStep3No,
                                hangedStep3Yes);
                ...
                DecisionNode towerStep2Yes = new DecisionNode("Do you welcome disruption?", towerStep3Yes,
                                towerStep3No);
                DecisionNode towerStep2No = new DecisionNode("Are you resistant to change?", towerStep3No,
                                towerStep3Yes);
                ...
                DecisionNode starStep2No = new DecisionNode("Are you searching for guidance?", starStep3No,
                                starStep3Yes);
                ...
                DecisionNode moonStep2No = new DecisionNode("Are you guided by imagination?", moonStep3No,
                                moonStep3Yes);
                ...
                DecisionNode judgementStep2No = new DecisionNode("Are you judging yourself?", judgementStep3No,
                                judgementStep3Yes);
                DecisionNode judgementRoot = new DecisionNode("Do you seek rebirth?", judgementStep2Yes,
                                judgementStep2No);
